...
{   
    ...
    NodePage load_node_page(int64_t table_id, pagenum_t page_number, int& pin_id, bool pin = false);
    void save_node_page(int64_t table_id, pagenum_t page_number, NodePage& node, int pin_id, bool cancel = false);
