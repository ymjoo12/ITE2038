...
TEST_F(PageManagementTest, CheckFileAllocFree)
{
    ...
    EXPECT_TRUE(TestUtil::IsAllocatedPage(table_id, allocated_page));
    ...
    EXPECT_TRUE(TestUtil::IsAllocatedPage(table_id, freed_page));
    ...
    EXPECT_FALSE(TestUtil::IsAllocatedPage(table_id, freed_page));
}
...
protected:
    ...
    void SetUp() override {
        ...
        EXPECT_TRUE(TestUtil::IsAllocatedPage(table_id, allocated_page_number));
    }
    void TearDown() override {
        file_close_table_files();
        EXPECT_TRUE(TestUtil::IsValidClosedFile(table_id));
