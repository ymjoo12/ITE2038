...
constexpr size_t SLOT_SIZE = 12;                                  // 12 B
constexpr size_t EDGE_SIZE = 16;                                  // 16 B
constexpr size_t VALUE_MAX_SIZE = 112;                            // 112 B
constexpr size_t VALUE_MIN_SIZE = 50;                             // 50 B
...
struct NodePage
{
  ...
  struct page_header_t
  {
    ...
    char reserved[HEADER_SIZE - 32];        // 96 bytes (reserved)
